...
function HomeContent() {
  ...
  return (
    <>
      ...
      {/* WhatsApp flutuante */}
      <a href="https://chat.whatsapp.com/BT0oMJt9R5GLxjGpQu8qZ2?s=cl&p=a&mlu=4&ilr=4" target="_blank" rel="noopener noreferrer" className={styles.waFloat} aria-label="WhatsApp">
